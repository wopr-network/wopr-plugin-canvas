 ...
 * Hook handler types.
 */
export type MessageIncomingHandler = (event: MutableHookEvent<{
    message: string;
    from: string;
    channel?: ChannelRef;
}>) => void | Promise<void>;
export type MessageOutgoingHandler = (event: MutableHookEvent<{
    response: string;
    from: string;
    channel?: ChannelRef;
}>) => void | Promise<void>;
...
export type ChannelMessageHandler = (event: MutableHookEvent<{
    channel: ChannelRef;
    message: string;
    from: string;
    metadata?: unknown;
